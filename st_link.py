...
colors = {
    ...
    '1': '\033[1m\033[38;2;255;255;255m\033[48;2;40;129;63m',
    '2': '\033[1m\033[38;2;255;255;255m\033[48;2;0;124;173m'
}
...
class TrainGetter():
        ...
        match args.line:
            case '1':
                self.name_to_index = {
                    ...
                    "SODO": 13,
                    "Stadium": 14,
                    "Int'l Dist/Chinatown": 15,
                    "Pioneer Square": 16,
                    "Symphony": 17,
                    "Westlake": 18,
                    "Capitol Hill": 19,
                    "Univ of Washington": 20,
                    "U District": 21,
                    "Roosevelt": 22,
                    "Northgate": 23,
                    "Pinehurst": 24,
                    "Shoreline South/148th": 25,
                    "Shoreline North/185th": 26,
                    "Mountlake Terrace": 27,
                    "Lynnwood City Center": 28
                }
            case '2':
                self.name_to_index = {
                    "Downtown Redmond": 0,
    ...
    def process_train(self, trip_dict, api_dict):
        ...
        if direction == self.endpoint_name:
            pct_distance_along_trip = 1 - (trip_dict["status"]["scheduledDistanceAlongTrip"] / trip_dict["status"]["scheduledDistanceAlongTrip"])
        else:
